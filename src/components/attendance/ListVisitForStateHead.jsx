...
import VisitedCardOfStateHead from "./VisitCardOfStateHead"
import { attendanceServices } from "../../../src/services/attendanceServices"
const ListVisitForStateHead = ({ data }) => {
    ...
    <View style={styles.container}>
      <View style={styles.infoCard}>
        <View>
          ...
          <Text style={styles.bold}>
            No of Visit : {data.shopVisited.length}
          </Text>
        </View>
      </View>
      {/* shop list */}
      <ScrollView>
        ...
        <View>
          {data.shopVisited.map((visit) => (
            <VisitedCardOfStateHead key={visit._id} data={visit} />
          ))}
        </View>
...
export default ListVisitForStateHead
